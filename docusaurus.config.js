...
const config = {
  ...
  scripts: [
    ...
    {
      src: "/rdk_studio_doc/js/dify-config.js",
    },
    {
    ...
    {
      src: `/rdk_studio_doc${localePrefix}/js/umami-events.js`,
      defer: true,
    },
  ],
  headTags: [
